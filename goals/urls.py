...
urlpatterns = [
    ...
    path('goal_board/create', views.BoardCreatedView.as_view(), name='create-board'),
    path('goal_board/list', views.BoardLisrView.as_view(), name='board-list'),
    path('goal_board/<int:pk>', views.BoardView.as_view(), name='board'),
]
